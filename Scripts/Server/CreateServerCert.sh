...
log "Downloading EASY-RSA" "wget -q -O - 'https://github.com/OpenVPN/easy-rsa/releases/download/v3.1.0/EasyRSA-3.1.0.tgz' | tar zxv" "Cannot download EasyRSA"
log "Moving EASY-RSA folder to Install directory" "mv EasyRSA-3.1.0 $WD_DIR/Install/EasyRSA" "Cannot move EASY-RSA directory"
